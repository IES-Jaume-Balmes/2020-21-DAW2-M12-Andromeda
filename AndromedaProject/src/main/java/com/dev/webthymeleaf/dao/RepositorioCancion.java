...
public interface RepositorioCancion extends JpaRepository<Cancion,Long>{
	@Query(value = "select cancion, artista, genero, url from cancion c, artista a, cancion_artista ca where c.id_cancion=ca.id_cancion and ca.id_artista=a.id_artista order by c.cancion;", nativeQuery = true)
