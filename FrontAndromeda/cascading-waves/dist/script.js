...
function arc(x, y, radius, startAngle, endAngle, anticlockwise) {var _x3, _y3, _radius, _startAngle, _endAngle, _anticlockwise;
  if (isVectorish(x)) {
    // Shift args down 1
...
function ellipse(x, y, rX, rY, rot, angStart, angEnd, antiCw) {var _x5, _y5, _rX2, _rY, _rot, _angStart, _angEnd, _antiCw;
  if (isVectorish(x)) {
